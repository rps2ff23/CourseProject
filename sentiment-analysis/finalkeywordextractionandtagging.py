...
#print(data_train['Cleaned Reviews'])

# function to lemmatize text
def lemmatization(texts):
    output = []
    for i in texts.split():
        s = [token.lemma_ if token.lemma_ != '-PRON-' else token.lemma_ for token in nlp(i)]
...
#y = bag_words.fit_transform(data_train['Cleaned Reviews'])
#print(y)
...
#bag_words.inverse_transform(y_pred)[3]
...
for i in range(5):
    ...
    print(xval[k])
    print("Original Review Text", data_train['reviews'][k], "\nCleansed Review Text: ", final_data['Cleaned Reviews'][k], "\nPredicted Keywords: ", infer_tags(xval[k])), print("Actual keyword: ",final_data['keyword'][k], "\n")
