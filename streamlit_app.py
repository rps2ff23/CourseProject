...
def load_model(fileid, sentiment_fileid):
    ...
    sentiment_output = 'saved_model_sentiment50'
...
if text != '' and clicked:
    ...
    sentiment_prediction = sentiment_rating("sentiment_analysis/reviewsABSA.csv", text, '/app/courseproject/saved_model_sentiment50')
